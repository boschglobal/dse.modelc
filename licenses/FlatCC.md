...
| License:    | Apache License 2.0 (https://github.com/dvidelabs/flatcc/blob/master/LICENSE)
| Additional: | NOTICE (https://github.com/dvidelabs/flatcc/blob/master/NOTICE)
| Copyright:  |

> Note: FlatCC is used to generate source code which is integrated with this project. Several FlatCC source files are integrated into this project, they represent the FlatCC Runtime Library.
